...
public static class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<DatabaseContext>(options =>
                options.UseSqlServer(serviceConfiguration.ConnectionStrings.OrderService));
        ...
        builder.Services.AddScoped<IOrderProcessJobRepository, OrderProcessJobRepository>();
        ...
        builder.Services.AddHealthChecks(serviceConfiguration.ConnectionStrings.OrderService);
